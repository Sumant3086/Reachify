...
function NotificationToast({ message, type, onClose, duration = 5000 }: Props) {
  useEffect(() => {
  ...
  return (
    <div className={`fixed top-4 right-4 z-[100] max-w-md w-full animate-slide-in-right`}>
      <div className={`flex items-start gap-3 p-4 rounded-xl border-l-4 shadow-lg backdrop-blur-sm ${styles[type]}`}>
